...
const Studentprofile = () => {
    return (
        ...
        >
            ...
            <div className="row">
                <div style={{ height: "25vh" }} className="d-flex  flex-column justify-content-between ">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <div className="profile-details">
                                <p className="admin-no mb-1">
                                    <span className="text-muted fs-6 custom-text-color">Admin No:</span>
                                    <span className="fw-semibold text-dark fs-6"> HYD 253487918</span>
                                </p>
                                <h2 className="fw-bold mb-2">Devansh.N</h2>
                            ...
                            <div className="row px-5">
                                <div className="col-md-4 mb-3 ">
                                    ...
                                    <p className=" Names1  mb-0">Class 8 with Techno</p>
                                </div>
                                <div className="col-md-4 mb-3">
                                    <p className="mb-0 Names small">Admission Type</p>
                                    <p className=" Names1  mb-0">Direct Walkin</p>
                                </div>
                                <div className="col-md-4 mb-3">
                                ...
                                <div className="col-md-4 mb-3">
                                    ...
                                    <p className="Names1 mb-0">Current</p>
                                </div>
                                <div className="col-md-4 mb-3 ">
                                    <p className="mb-0 Names small">Student Type</p>
                                    <p className="Names1 mb-0">Residential</p>
                                </div>
                                <div className="col-md-4 mb-3 ">
                                    <p className="mb-0 Names small">Section</p>
                                    <p className="Names1 mb-0">8A</p>
                                </div>
                            </div>
                        </div>
                        <Button
